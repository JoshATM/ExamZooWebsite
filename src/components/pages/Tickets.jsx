...
// London Zoo Prices
  const adultPrice = 33.00;
  const childrenPrice = 21.00;
  const seniorsPrice = 31.00;
  const Total = (adults * adultPrice) + (children * childrenPrice) + (seniors * seniorsPrice);
          ...
          <CalenderTitle>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                <path d="M10 20A10 10 0 1 0 0 10a10 10 0 0 0 10 10zm1.289-15.7 1.422 1.4-4.3 4.344 4.289 4.245-1.4 1.422-5.714-5.648"
                fill={
                    currentMonth === new Date().getMonth() &&
                    currentYear === new Date().getFullYear()
                      ? "#ccc"
            ...
            {GetMonthYear}
            <StyledArrowButton onClick={handleNextMonth}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path d="M10 20A10 10 0 1 0 0 10a10 10 0 0 0 10 10zM8.711 4.3l5.7 5.766L8.7 15.711l-1.4-1.422 4.289-4.242-4.3-4.347"fill="white"/></svg></StyledArrowButton>
          </CalenderTitle>
          <CalenderDays>
          ...
          <>
            ...
            <PersonTypeContainer>
              <PersonTypeCardContainer>
                <PersonTypeStyledText>Adult: £{adultPrice}</PersonTypeStyledText>
              ...
              <PersonTypeCardContainer>
                <PersonTypeStyledText>Children: £{childrenPrice}</PersonTypeStyledText>
                <PersonTypeButtonContainer>
              ...
              <PersonTypeCardContainer>
                <PersonTypeStyledText>Seniors: £{seniorsPrice}</PersonTypeStyledText>
                <PersonTypeButtonContainer>
