    ...
    <HomeContainer>
      ...
      <TextBoxContainer>
        <TextBox>
          ...
          <StyledContainerText>
            Welcome to our vibrant and dynamic zoo, where the magic of nature
            meets the joy of discovery! Our website is designed to transport you
            to a world where wildlife roams freely, and every visit is an
            adventure.
          </StyledContainerText>
        </TextBox>
        <TextBox>
          ...
          <StyledContainerText>
            Explore our vast collection of exotic animals, from the majestic
            elephants to the playful monkeys, all in a beautifully landscaped
            environment that mimics their natural habitats.
          </StyledContainerText>
        </TextBox>
        <TextBox>
          <StyledContainerImage src={Orangatang} alt="Orangatang" />
          <StyledContainerText>
            Capture the essence of our zoo with stunning images and videos that
            showcase the beauty and diversity of our animal collection.
          </StyledContainerText>
        </TextBox>
      </TextBoxContainer>
        ...
        <InverseTextBox>
          ...
          <div>
            <InverseContainerText>
              Join us on this journey of discovery and conservation. Your visit
              to our zoo is more than just a day out; it's a step towards a
              better future for wildlife and the planet.
            </InverseContainerText>
            <InverseContainerText>
              Don't wait! Book your tickets today and embark on an unforgettable
              adventure at our zoo.
            </InverseContainerText>
          </div>
        </InverseTextBox>
      </InverseTextBoxContainer>
