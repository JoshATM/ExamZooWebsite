...
export default function Hotel() {
  ...
  return (
    <StyledContainer>
      ...
      <CardContainer>
        {/* Waits until a day is selected and then displays the hotel rooms available */}
        {selectedDay != null ? (
          <>
            <p>
            ...
            <PersonTypeContainer>
              <PersonTypeCardContainer>
                <PersonTypeStyledText>Rooms: £{roomPrice}</PersonTypeStyledText>
                <PersonTypeButtonContainer>
                  <PersonTypeButton onClick={roomsDecrement}>
                    -
                  </PersonTypeButton>
                  <span>{rooms}</span>
                  <PersonTypeButton onClick={roomsIncrement}>
                    +
                  </PersonTypeButton>
                </PersonTypeButtonContainer>
              </PersonTypeCardContainer>
              <PriceText>Total: £{rooms * roomPrice}</PriceText>
