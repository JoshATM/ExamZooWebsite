  ...
  return (
    <div>
      ...
      <h3>
        ...
        mobile device) when you browse websites. They are used to make websites
      ...
      <h4>
        ...
        enable you to navigate our site and use its features. Without these
        cookies, certain services on our website may not be available.
      </h4>

      <h3>Analytical/Performance Cookies:</h3>
      <h4>
        These cookies allow us to analyze how visitors use our website, so we
        can measure and improve its performance. For example, these cookies help
        us understand which pages are the most and least popular and how
      ...
      <h4>
        ...
        your interests. They may be used by advertising networks to track your
        browsing activity across different websites and to display targeted ads.
        Managing Cookies
      </h4>
      ...
      <h3>
        ...
        cookies that are already on your device and you can set most browsers to
